...
function ifJetstreamBound(b,x) {
    if (Math.round(random(1,13)) == 2) return b.hemY(random(HEIGHT*0.54,HEIGHT*0.67));
...
SPAWN_RULES.defaults.archetypes = {
	...
	'at1': {
        x: ()=>random(0.0745*WIDTH,0.185*WIDTH),
        y: (b)=>b.hemY(random(0.5*HEIGHT,0.533*HEIGHT)),
        pressure: [1000, 1020],
        windSpeed: [15, 35],
        type: TROPWAVE,
        organization: [0,0.3],
	...
	'at2': {
        x: ()=>random(0.052*WIDTH,0.2*WIDTH),
        y: (b)=>b.hemY(random(0.533*HEIGHT,0.685*HEIGHT)),
        pressure: [1000, 1020],
        windSpeed: [15, 35],
        type: TROPWAVE,
        organization: [0,0.3],
	...
	'at3': {
        x: ()=>random(0.142*WIDTH,0.202*WIDTH),
        y: (b)=>b.hemY(random(0.685*HEIGHT,0.733*HEIGHT)),
        pressure: [1000, 1020],
        windSpeed: [15, 35],
        type: TROPWAVE,
        organization: [0,0.3],
	...
	'at4': {
        x: ()=>random(0.184*WIDTH,0.202*WIDTH),
        y: (b)=>b.hemY(random(0.733*HEIGHT,0.833*HEIGHT)),
        pressure: [1000, 1020],
        windSpeed: [15, 35],
        type: TROPWAVE,
        organization: [0,0.3],
	...
	'at5': {
        x: ()=>random(0.2*WIDTH,0.417*WIDTH),
        y: (b)=>b.hemY(random(0.476*HEIGHT,0.694*HEIGHT)),
        pressure: [1000, 1020],
        windSpeed: [15, 35],
        type: TROPWAVE,
        organization: [0,0.3],
	...
	'at6': {
        x: ()=>random(0.2*WIDTH,0.417*WIDTH),
        y: (b)=>b.hemY(random(0.694*HEIGHT,0.833*HEIGHT)),
        pressure: [1000, 1020],
        windSpeed: [15, 35],
        type: TROPWAVE,
        organization: [0,0.3],
	...
	'at7': {
        x: ()=>random(0.417*WIDTH,0.8125*WIDTH),
        y: (b)=>b.hemY(random(0.426*HEIGHT,0.63*HEIGHT)),
        pressure: [1000, 1020],
        windSpeed: [15, 35],
        type: TROPWAVE,
        organization: [0,0.3],
	...
	'at9': {
        x: ()=>random(0.224*WIDTH,0.417*WIDTH),
        y: (b)=>b.hemY(random(0.476*HEIGHT,0.694*HEIGHT)),
        pressure: [1000, 1020],
        windSpeed: [15, 35],
        type: TROPWAVE,
	...
	'at10': {
        x: ()=>random(0.26*WIDTH,0.88*WIDTH),
        y: (b)=>b.hemY(random(0.31*HEIGHT,0.426*HEIGHT)),
        pressure: [1000, 1020],
        windSpeed: [15, 35],
        type: TROPWAVE,
        organization: [0,0.3],
	...
	'at11': {
        x: ()=>random(0.001*WIDTH,0.114*WIDTH),
        y: (b)=>b.hemY(random(0.71*HEIGHT,0.78*HEIGHT)),
        pressure: [1000, 1020],
        windSpeed: [15, 35],
        type: TROPWAVE,
        organization: [0,0.3],
	...
	'at12': {
        x: ()=>random(0.001*WIDTH,0.176*WIDTH),
        y: (b)=>b.hemY(random(0.78*HEIGHT,0.9*HEIGHT)),
        pressure: [1000, 1020],
        windSpeed: [15, 35],
        type: TROPWAVE,
        organization: [0,0.3],
...
ENV_DEFS.defaults.ULSteering = {
    ...
    mapFunc: (u,x,y,z)=>{
        ...
        m = pow(1.65,map(m,0,1,-8,4))*jOP;                                                       // noise magnitude
